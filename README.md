# The DI Package [![Build Status](https://ci.joomla.org/api/badges/joomla-framework/di/status.svg?ref=refs/heads/3.x-dev)](https://ci.joomla.org/joomla-framework/di)
